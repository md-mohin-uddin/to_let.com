...
<html lang="en">
  <head>
    ...
    <!-- title -->
    <title>Admin Panel - ToLet.com</title>
  ...
  <body>
    ...
    @else
            <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{url('admin/home')}}"><i class="icon ion-android-star-outline"></i> ToLet.com</a></div>
      ...
      <div class="sl-sideleft-menu">
        ...
        @if(Auth::user()->orders == 1)
            <a href="#" class="sl-menu-link">
                ...
                <span class="menu-item-label">Rent Request</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{route('admin.add.order')}}" class="nav-link">Add New Rent Request</a></li>
                <li class="nav-item"><a href="{{route('admin.new.order')}}" class="nav-link">New Pending Rent Request</a></li>
                <li class="nav-item"><a href="{{route('admin.all.order')}}" class="nav-link">All Rent Request</a></li>
            </ul>
        @else
        @endif
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                ...
                <img src="{{asset('public/default.png')}}" class="wd-32 rounded-circle" alt="">
            </a>
            ...
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                ...
                <div class="media-body">
                  ...
                  <span class="tx-12">October 03, 2022 8:45am</span>
                </div>
              </div><!-- media -->
            </a>
            <!-- loop ends here -->
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                ...
                <div class="media-body">
                  ...
                  <span class="tx-12">October 02, 2022 12:44am</span>
                </div>
              </div><!-- media -->
            </a>
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                ...
                <div class="media-body">
                  ...
                  <span class="tx-12">October 01, 2022 10:20pm</span>
                </div>
              </div><!-- media -->
            </a>
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                ...
                <div class="media-body">
                  ...
                  <span class="tx-12">October 01, 2022 6:08pm</span>
                </div>
              </div><!-- media -->
            </a>
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                ...
                <div class="media-body">
                  ...
                  <span class="tx-12">September 27, 2022 6:45am</span>
                </div>
              </div><!-- media -->
            </a>
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                ...
                <div class="media-body">
                  ...
                  <span class="tx-12">September 28, 2022 11:30pm</span>
                </div>
              </div><!-- media -->
            </a>
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                ...
                <div class="media-body">
                  ...
                  <span class="tx-12">September 26, 2022 11:01am</span>
                </div>
              </div><!-- media -->
            </a>
            <a href="" class="media-list-link read">
              <div class="media pd-x-Fre pd-y-15">
                <img src="../img/img5.jpg" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
                  <p class="tx-13 mg-b-0 tx-gray-700"><strong class="tx-medium tx-gray-800">Julius Erving</strong> wants to connect with you on your conversation with <strong class="tx-medium tx-gray-800">Ronnie Mara</strong></p>
                  <span class="tx-12">September 23, 2022 9:19pm</span>
                </div>
              </div><!-- media -->
            </a>
          </div><!-- media-list -->
