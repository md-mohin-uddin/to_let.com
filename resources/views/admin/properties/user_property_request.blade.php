                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ URL::to('edit/property/'.$row->id) }}" class="btn btn-sm btn-info"
                                    title="Edit"><i class="fa fa-edit"></i></a>
                                {{-- <a href="{{ URL::to('delete/property/'.$row->id) }}" class="btn btn-sm btn-danger"
                                    title="Delete" id="delete"><i class="fa fa-trash"></i></a> --}}
                                <a href="{{ URL::to('view/property/'.$row->id) }}" class="btn btn-sm btn-warning"
                                    title="View_Details"><i class="fa fa-eye"></i></a>
                                <a href="{{ url('admin/property/cancel/'.$row->id) }}" class="btn btn-sm btn-danger"
