         	...
         	<div class="col-md-6">
         	    <div class="card">
         	    	...
         	    	<table class="table">
                        ...
                        <tr>
                            <th>Date-Time :</th>
                            <th>{{ date('d M, Y h:i A', strtotime($property->created_at)) }}</th>
                        </tr>
                        <tr>
                            <th>Year :</th>
                            <th>{{ $property->year }}</th>
                        ...
                        @if(isset($property->amount) && isset($property->transaction_id))
                            <tr>
                                <th>Payment :</th>
                                <th><span class="badge badge-primary p-1">Paid (৳{{$property->amount}})</span></th>
...
//------------------------------------------------------------------------------->
    ...
    @if($property->status == 0)
        ...
        <a
            ...
            data-route="{{ url('admin/property/cancel/'.$property->id) }}"
            class="btn btn-danger cancelPropertry"

        >
            <i class="fa fa-times"></i>&nbsp; Cancel Property
        </a>
        {{-- <button class="btn btn-danger cancelPropertry"><i class="fa fa-times"></i>&nbsp; Cancel Property</button> --}}
    ...
    @elseif($property->status == 1)
        ...
        <a
            ...
            data-route="{{ url('admin/property/pending/'.$property->id) }}"
    ...
    @elseif($property->status == 2)
        ...
        <a
            ...
            data-route="{{ url('admin/property/backToUpload/'.$property->id) }}"
...
@endphp
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reportModalLabel">@lang('Cancel Property!')</h5>
                ...
                <form action="" method="post" class="cancelPropertrySubmit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="reason">@lang('Cancel Reason : ')</label>
                            <textarea name="comment" id="comment" cols="30" rows="4" class="form-control" required placeholder="@lang('type here...')"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        {{-- <button type="button" class="btn-flower btn1" data-dismiss="modal">@lang('Cancel')</button>
    ...
    <div class="modal fade" id="pendingPropertry" tabindex="-1" data-backdrop="static" aria-labelledby="reportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reportModalLabel">@lang('Make Property Pending!')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="" method="post" class="pendingPropertrySubmit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="reason">@lang('Make Pending Reason : ')</label>
                            <textarea name="comment" id="comment" cols="30" rows="4" class="form-control" required placeholder="@lang('type here...')"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal fade" id="backToUploadPropertry" tabindex="-1" data-backdrop="static" aria-labelledby="reportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reportModalLabel">@lang('Back To Upload Propertry!')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="" method="post" class="backToUploadPropertrySubmit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="reason">@lang('Back To Upload Reason : ')</label>
                            <textarea name="comment" id="comment" cols="30" rows="4" class="form-control" required placeholder="@lang('type here...')"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
