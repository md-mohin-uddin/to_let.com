...
Route::post('admin/property/backToUpload/{id}', 'Admin\PropertyController@backToUploadProperty');
Route::post('admin/property/cancel/{id}', 'Admin\PropertyController@cancelProperty');
...
Route::post('admin/property/pending/{id}', 'Admin\PropertyController@pendingProperty');
...
Route::get('user/uploaded/property','FrontController@userUploadedProperty')->name('uploaded.property.user'); //list
Route::get('user/uploaded/property/view/{id}','FrontController@userUploadedPropertyView');  //view
