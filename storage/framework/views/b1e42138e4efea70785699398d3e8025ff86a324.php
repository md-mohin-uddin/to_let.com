      ...
      <div class="sl-pagebody">
         	    ...
         	    <div class="card">
         	    	...
         	    	<table class="table">
                        ...
                        <?php if(isset($property->amount) && isset($property->transaction_id)): ?>
                            <tr>
                                <th>Payment :</th>
                                <th>৳ <?php echo e($property->amount); ?></th>
                            </tr>
                            <tr>
        ...
        <div class="col-lg-12">
            ...
            <label class="form-control-label">Video Link : <span class="tx-danger">*</span></label>
              <br>
            <p style="margin-left: 35px"><?php echo e($property->video); ?></p>
          </div>
        </div>
        <div class="col-lg-12">
            <div class="form-group" style="border:1px solid grey;padding:10px;">
...
//------------------------------------------------------------------------------->
    ...
    <?php if($property->status == 0): ?>
        ...
        <a href="<?php echo e(url('admin/property/cancel/'.$property->id)); ?>" class="btn btn-danger" id="cancel"><i class="fa fa-times"></i>&nbsp; Cancel Property</a>
    ...
    <?php elseif($property->status == 1): ?>
        ...
        <a href="<?php echo e(url('admin/property/pending/'.$property->id)); ?>" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp; Sent Back to Pending Stage</a>
    ...
    <?php elseif($property->status == 2): ?>
        ...
        <a href="<?php echo e(url('admin/property/accept/'.$property->id)); ?>" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp; Sent Back to Upload stage</a>
...
<?php echo $__env->make('admin.admin_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HouseRental\resources\views/admin/properties/show.blade.php ENDPATH**/ ?>