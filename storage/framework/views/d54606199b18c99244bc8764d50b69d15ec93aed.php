          ...
          <h6 class="card-body-title">
            <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($row->status == 0): ?>
                    ...
                    <a href="<?php echo e(route('admin.all.order')); ?>" class="btn btn-sm btn-info" style="float: right;" >All Orders</a> <?php break; ?>
                <?php else: ?>
                    All Orders List For Property
                    <a href="<?php echo e(route('admin.new.order')); ?>" class="btn btn-sm btn-info" style="float: right;" >New Orders</a> <?php break; ?>
                <?php endif; ?>
...
<?php echo $__env->make('admin.admin_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HouseRental\resources\views/admin/order/orders.blade.php ENDPATH**/ ?>