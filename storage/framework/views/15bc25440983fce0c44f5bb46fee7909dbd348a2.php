<?php $__env->startSection('admin_content'); ?>
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <form action="<?php echo e(route('update.admin')); ?>" method="post" >
          	<?php echo csrf_field(); ?>
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="phone"  required="" value="<?php echo e($user->phone); ?>">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
...
<?php echo $__env->make('admin.admin_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\houserental-mohin\resources\views/admin/role/edit_role.blade.php ENDPATH**/ ?>