...
<html lang="en">
  ...
  <body>
    ...
    <?php else: ?>
            <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="<?php echo e(url('admin/home')); ?>"><i class="icon ion-android-star-outline"></i> ToLet.com</a></div>
    <div class="sl-sideleft">
      <div class="sl-sideleft-menu">
        ...
        <?php if(Auth::user()->orders == 1): ?>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="<?php echo e(route('admin.add.order')); ?>" class="nav-link">Add New Rent Request</a></li>
                <li class="nav-item"><a href="<?php echo e(route('admin.new.order')); ?>" class="nav-link">New Pending Rent Request</a></li>
                <li class="nav-item"><a href="<?php echo e(route('admin.all.order')); ?>" class="nav-link">All Rent Request</a></li>
            </ul>
        <?php else: ?>
        <?php endif; ?>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                ...
                <img src="<?php echo e(asset('public/default.png')); ?>" class="wd-32 rounded-circle" alt="">
            </a>
...
<?php /**PATH C:\xampp\htdocs\houserental-mohin\resources\views/admin/admin_layouts.blade.php ENDPATH**/ ?>