              ...
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" data-placeholder="Choose Category" name="category_id" required>
                    ...
                    <option value="<?php echo e($row->id); ?>"><?php echo e($row->category_name_en); ?></option>
...
<?php echo $__env->make('admin.admin_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HouseRental\resources\views/admin/blog/create.blade.php ENDPATH**/ ?>