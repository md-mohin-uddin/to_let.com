    ...
    <!------User-Profile----------------------->
                <div class="col-4" data-aos="fade-left">
                    <div class="card" style="width: 18rem;">
                        ...
                        <li class="list-group-item more moreS py-1"><a href="<?php echo e(route('uploaded.property.user')); ?>" class="button-pipaluk button--inverted pl-4 py-2 text-primary ml-4" style="padding-right:35px;">Uploaded Property</a></li>
                        </ul>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\houserental-mohin\resources\views/home.blade.php ENDPATH**/ ?>