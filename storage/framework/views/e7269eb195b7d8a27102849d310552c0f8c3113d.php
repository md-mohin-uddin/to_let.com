...
<div class="top_bar">
    ...
    <!------Languaga(bangla/english)------->
                    ...
                    ?>
                        ...
                        <?php else: ?>
                        <a href="<?php echo e(route('language.bangla')); ?>" class="button-pipaluk button--inverted px-3 py-2 mt-2">Bangla</a> <!--বাংলা-->
                        <?php endif; ?>
                    </div>
    ...
    <div class=" footer2 text-center">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>
                        Copyright &copy; 2023 All Rights Reserved By : <span><a href="https://facebook.com/umdmohin" target="_blank"> Md Mohin Uddin </a> & <a href="https://facebook.com/" target="_blank"> Akram Shah Rokib </a></span>
                    </p>
...
<?php /**PATH C:\xampp\htdocs\HouseRental\resources\views/layouts/app.blade.php ENDPATH**/ ?>