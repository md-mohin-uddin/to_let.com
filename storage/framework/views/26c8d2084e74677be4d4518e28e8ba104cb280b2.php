                    ...
                    <!-- <ul class="cat_menu pb-2 pt-2"> -->
                        <?php $__currentLoopData = $city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <!-- <li class="hassubs more moreNav"> -->
                                <!-- <a href="<?php echo e(url('city/properties/'.$cat->id)); ?>" class="button-pipaluk button--inverted pl-5"><?php echo e($cat->city_name); ?><i class="fas fa-arrow-circle-right pr-3"></i></a> button-pipaluk button--inverted px-5 my-1 -->
                                <!-- <ul class="py-1">
                                    <?php
...
<?php /**PATH C:\xampp\htdocs\houserental-mohin\resources\views/layouts/menubar.blade.php ENDPATH**/ ?>