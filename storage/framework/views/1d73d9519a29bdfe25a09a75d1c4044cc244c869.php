...
<form action="<?php echo e(route('store.user.property')); ?>" method="post" enctype="multipart/form-data" class="border border-secondary bg-success text-light rounded p-5" style="font-size: 16px;" >
        <?php echo csrf_field(); ?>
            ...
            <div class="col-md-6">
                ...
                <div class="card bg-light text-dark my-2">
                    ...
                    <div class="collapse" id="questionSix" data-parent="#accordion">
                        <div class="card-body">
                        <p class="mb-0" style="font-size: 15px">If you need help editing or managing your listings, please contact us at <a href="mailto:<?php echo e($setting->email_one); ?>"><?php echo e($setting->email_one); ?></a>. For questions specific to Rental Manager, please visit the Offices.<br><br> We’re always open to feedback that will help us give you the best experience possible. For feedback on other types of rentals  Send your feedback on other types of rentals,thoughts and suggestions to <a href="mailto:<?php echo e($setting->email_two); ?>"><?php echo e($setting->email_two); ?></a> </p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\houserental-mohin\resources\views/pages/user_add_property.blade.php ENDPATH**/ ?>