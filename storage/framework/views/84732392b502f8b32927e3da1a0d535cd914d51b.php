...
<div style="background: #F5F5FA; padding-bottom:80px" data-aos="fade-right">
    ...
    <div class="py-4">
        <div class="container">
            <h3 style="font-size: 30px" class="text-primary mb-0"><a href="<?php echo e(route('user.wishlist')); ?>">Your Wishlists : </a></h3>
            <p style="font-size: 17px; margin-top:0px"> <span class="badge badge-success text-white rounded-circle p-1"><?php echo e(count($wishlistCount)); ?> </span> Saved Property.</p>
        </div>
    </div>
...
<?php $__currentLoopData = $property; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="col-md-5 ml-0 pl-0">
        ...
        <!--------'wishlist' using ajax------->
            <div class="carousel-caption" style="transform: translate(70px,-221px)">
                <button class="addwishlist float-right" data-id="<?php echo e($row->property_id); ?>" role="button" style="background: none; border-style:none;" title="Add to wishlist">
        ...
        <!---------(Discount equation)-------->
            <div class="carousel-caption" style="transform: translate(-70px,-216px)">
                ...
                <a href="<?php echo e(url('property/details/'.$row->property_id)); ?>" title="Click for details">
    ...
    <?php endif; ?>
        <p style="font-size: 15px" class="text-dark mb-0 pb-0" title="Place"><i class="fas fa-map-marker-alt mr-2 p-0" style="font-size:13px;"></i><?php echo e($row->address); ?>, <?php echo e($row->subcity_name); ?>, <?php echo e($row->city_name); ?>.</p>
    ...
    <?php endif; ?>
        ...
        <div class="more">
            <a class="btn btn-white py-2 px-4 mr-3 text-white button-pipaluk button--inverted" style="font-size: 18px" roll="button" data-toggle="modal" data-target="#call<?php echo e($row->property_id); ?>"><i class="fas fa-phone pr-1"></i> Call </a>
            <a class="btn py-2 px-4 text-white button-pipaluk button--inverted" style="font-size: 18px" roll="button" data-toggle="modal" data-target="#email<?php echo e($row->property_id); ?>"><i class="far fa-envelope pr-1"></i> Email </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HouseRental\resources\views/pages/wishlist.blade.php ENDPATH**/ ?>